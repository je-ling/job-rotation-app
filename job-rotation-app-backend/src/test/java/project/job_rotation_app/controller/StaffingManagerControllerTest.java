...
public class StaffingManagerControllerTest {
  ...
  public void testGetAvailableRolesByGrade200() {
    ...
    when(staffingManagerBusinessService.getAvailableRolesByGrade(Grades.GRADE_2)).thenReturn(roles);
  ...
  public void testGetAvailableRolesByGradeEmptyList200() {
    ...
    when(staffingManagerBusinessService.getAvailableRolesByGrade(Grades.GRADE_1)).thenReturn(
        roles);
    assertDoesNotThrow(
  ...
  public void testGetAvailableRolesByDept200() {
    ...
    when(staffingManagerBusinessService.getAvailableRolesByDepartment(
  ...
  public void testGetAvailableRolesByDeptEmptyList200() {
    ...
    List<Roles> result = staffingManagerBusinessService.getAvailableRolesByDepartment(
  ...
  public void testGetAvailableRolesByDuration200() {
    ...
    when(staffingManagerBusinessService.getAvailableRolesByDuration(
        Duration.NINE_MONTHS)).thenReturn(
        roles);
  ...
  public void testGetAvailableRolesByDurationEmptyList200() {
    ...
    when(staffingManagerBusinessService.getAvailableRolesByDuration(
        Duration.TWELVE_MONTHS)).thenReturn(
        roles);
