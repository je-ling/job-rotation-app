...
const ExpressInterestModal = ({ show, onClose }: ExpressInterestModalProps) => {
    return (
        <Modal show={show} onHide={onClose} centered>
            ...
            <Modal.Body>
                <p><strong>Inform your assignment manager</strong></p>
                <p> Make them them that you are looking for a new assignment and inform them once you have a successful assignment application.</p>
                ...
                <p>Once you have secured a new assignment, you will be assigned an end date for your current assignment to then be able to rotate to the new role or opportunity.</p>
